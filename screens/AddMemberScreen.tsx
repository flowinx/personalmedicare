...
export default function AddMemberScreen({ navigation }: AddMemberScreenProps) {
  ...
  }, [name, relation, dob, notes, avatar, navigation, clearForm]);
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.headerSection}>
          <TouchableOpacity onPress={pickImage} style={styles.compactAvatarButton}>
            {avatar ? (
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerSubtitle}>Adicione as informações do novo membro da família</Text>
          </View>
        </View>
